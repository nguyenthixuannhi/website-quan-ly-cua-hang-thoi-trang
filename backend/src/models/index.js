...
// --- DanhMuc ---
models.DanhMuc.hasMany(models.SanPham, { foreignKey: 'id_danh_muc', as: 'san_pham' });
models.DanhMuc.hasMany(models.ChiTietGiamGia, { foreignKey: 'id_danh_muc', as: 'chi_tiet_giam_gia' });

// --- SanPham ---
models.SanPham.belongsTo(models.DanhMuc, { foreignKey: 'id_danh_muc', as: 'danh_muc' });
models.SanPham.hasMany(models.KieuSanPham, { foreignKey: 'id_san_pham', as: 'bien_the' });
models.SanPham.hasMany(models.ChiTietGiamGia, { foreignKey: 'id_san_pham', as: 'chi_tiet_giam_gia' });

// --- KieuSanPham ---
models.KieuSanPham.belongsTo(models.SanPham, { foreignKey: 'id_san_pham', as: 'san_pham' });
models.KieuSanPham.hasMany(models.ChiTietDonHang, { foreignKey: 'id_bien_the', as: 'chi_tiet_don_hang' });
models.KieuSanPham.hasMany(models.ChiTietGioHang, { foreignKey: 'id_bien_the', as: 'chi_tiet_gio_hang' });
models.KieuSanPham.hasMany(models.ChiTietPhieuNhap, { foreignKey: 'id_bien_the', as: 'chi_tiet_phieu_nhap' });
models.KieuSanPham.hasMany(models.ChiTietTraHang, { foreignKey: 'id_bien_the', as: 'chi_tiet_tra_hang' });
models.KieuSanPham.hasMany(models.LichSuKho, { foreignKey: 'id_bien_the', as: 'lich_su_kho' });

// --- NguoiDung ---
models.NguoiDung.hasMany(models.DonHang, { foreignKey: 'id_nguoi_dung', as: 'don_hang' });
models.NguoiDung.hasOne(models.GioHang, { foreignKey: 'id_nguoi_dung', as: 'gio_hang' });
models.NguoiDung.hasMany(models.DiaChi, { foreignKey: 'id_nguoi_dung', as: 'dia_chi' });
models.NguoiDung.hasMany(models.ChuongTrinhGiamGia, { foreignKey: 'id_nguoi_dung', as: 'chuong_trinh_giam_gia' });
models.NguoiDung.hasMany(models.DonNhapHang, { foreignKey: 'id_nguoi_dung', as: 'don_nhap_hang' });
models.NguoiDung.hasMany(models.LichSuKho, { foreignKey: 'id_nguoi_dung', as: 'lich_su_kho' });

// --- NhaCungCap ---
models.NhaCungCap.hasMany(models.DonNhapHang, { foreignKey: 'id_nha_cung_cap', as: 'don_nhap_hang' });

// --- DonHang ---
models.DonHang.belongsTo(models.NguoiDung, { foreignKey: 'id_nguoi_dung', as: 'nguoi_dung' });
models.DonHang.hasMany(models.ChiTietDonHang, { foreignKey: 'id_don_hang', as: 'chi_tiet_don_hang' });
...
models.GioHang.hasMany(models.ChiTietGioHang, { foreignKey: 'id_gio_hang', as: 'chi_tiet_gio_hang' });
...
models.ChuongTrinhGiamGia.hasMany(models.ChiTietGiamGia, { foreignKey: 'id_giam_gia', as: 'chi_tiet_giam_gia' });
...
models.DonNhapHang.hasMany(models.ChiTietPhieuNhap, { foreignKey: 'id_don_nhap', as: 'chi_tiet_phieu_nhap' });
...
models.TraHang.hasMany(models.ChiTietTraHang, { foreignKey: 'id_phieu_tra', as: 'chi_tiet_tra_hang' });
